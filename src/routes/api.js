...
router.post('/apps/:appName/gitpull', isAuthenticated, isRoot, appsController.gitPullApp);
...
router.post('/system/git/clone', isAuthenticated, isRoot, systemController.gitClone);
